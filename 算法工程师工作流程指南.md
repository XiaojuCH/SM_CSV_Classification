...
# 复制文件
copy CPP/build/bin/Release/ClassifierDLL.dll 交付文件包/
copy CPP/build/bin/Release/onnxruntime.dll 交付文件包/
copy CPP/build/bin/Release/lightgbm_model.onnx 交付文件包/
copy CPP/build/bin/Release/scaler_params.json 交付文件包/
copy CPP/build/bin/Release/label_mapping.json 交付文件包/
copy CPP/ClassifierWrapper.cs 交付文件包/Classifier.cs
```
...
cd ../../../../
mkdir 交付文件包
copy CPP/build/bin/Release/*.dll 交付文件包/
copy CPP/build/bin/Release/*.onnx 交付文件包/
copy CPP/build/bin/Release/*.json 交付文件包/
copy CPP/ClassifierWrapper.cs 交付文件包/Classifier.cs
```
